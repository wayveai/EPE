...
if __name__ == '__main__':
	...
	src_dataset = ImageDataset('src', read_filelist(args.src_img_path, ['rgb']), data_root=args.data_root)
	dst_dataset = ImageDataset('dst', read_filelist(args.dst_img_path, ['rgb']), data_root=args.data_root)
